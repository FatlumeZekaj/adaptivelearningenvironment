    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="" action="<?php echo site_url('teacher/teacherr/payment_settings/paypal_settings'); ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <form class="" action="<?php echo site_url('teacher/teacherr/payment_settings/stripe_settings'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
