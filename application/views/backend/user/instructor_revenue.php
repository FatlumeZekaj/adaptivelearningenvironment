        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-6">
                        <form class="form-inline" action="<?php echo site_url('teacher/teacherr/instructor_revenue/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                            ...
                            <?php foreach ($payment_history as $payment):
                                ...
                                <tr class="gradeU">
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo site_url('teacher/teacherr/invoice/'.$payment['id']); ?>" class="btn btn-outline-primary btn-rounded btn-sm"><i class="mdi mdi-printer-settings"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
