...
function deleteQuizQuestionAndReloadModal(quizID, questionID) {
    var deletionURL = '<?php echo site_url(); ?>'+'teacher/teachercourses/quiz_questions/'+quizID+'/delete/'+questionID;
...
function sort() {
    ...
    $.ajax({
        url: '<?php echo site_url('teacher/teachercourses/ajax_sort_question/');?>',
        type : 'POST',
