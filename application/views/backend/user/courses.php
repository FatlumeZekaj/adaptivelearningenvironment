<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('courses'); ?> <!---ndryshim-->
                    <a href="<?php echo site_url('teacher/teachercourses/course_form/add_course'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_course'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    <div class="col">
                        <a href="<?php echo site_url('teacher/teachercourses/courses'); ?>" class="text-secondary">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('teacher/teachercourses/courses'); ?>" method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-3">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                        <strong><a href="<?php echo site_url('teacher/teachercourses/course_form/course_edit/'.$course['id']); ?>"><?php echo ellipsis($course['title']); ?></a></strong><br>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li><a class="dropdown-item" href="<?php echo site_url('teacher/teachercourses/course_form/course_edit/'.$course['id']); ?>"><?php echo get_phrase('edit_this_course');?></a></li>
                                              <li><a class="dropdown-item" href="<?php echo site_url('teacher/teachercourses/course_form/course_edit/'.$course['id']); ?>"><?php echo get_phrase('section_&_lesson');?></a></li>
                                              <?php if ($course['status'] == 'active' || $course['status'] == 'pending'): ?>
                                                  <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('teacher/teachercourses/course_actions/draft/'.$course['id']); ?>');"><?php echo get_phrase('mark_as_drafted'); ?></a></li>
                                              <?php else: ?>
                                                  <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('teacher/teachercourses/course_actions/publish/'.$course['id']); ?>');"><?php echo get_phrase('publish_this_course'); ?></a></li>
                                              <?php endif; ?>
