        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="" action="<?php echo site_url('admin/admin/payment_settings/system_currency'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="" action="<?php echo site_url('admin/admin/payment_settings/paypal_settings'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <form class="" action="<?php echo site_url('admin/admin/payment_settings/stripe_settings'); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label><?php echo get_phrase('active'); ?></label>
