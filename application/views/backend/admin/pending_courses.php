            ...
            <div class="panel-body">
              <div class="row">
                  <div class="col-md-4 col-md-offset-4">
                      <a href = "<?php echo site_url('admin/admincourses/course_form/add_course'); ?>" class="btn btn-block btn-info btn-lg" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('add_course'); ?></a>
                  </div>
              </div>
              <hr>
                          ...
                          <tr>
                              ...
                              <td hidden>
                                  <ul style="list-style-type:square">
                                      ...
                                      <a href="<?php echo site_url('admin/admin/watch_video/'.slugify($lesson['title']).'/'.$lesson['id']); ?>"><li><?php echo $lesson['title']; ?></li></a>
                                  <?php endforeach; ?>
                              </ul>
                          </td>
                          <td>
                          ...
                          <td>
                              <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu">
                                      ...
                                      <li>
                                          <a href="<?php echo site_url('admin/admincourses/sections/'.$course['id']); ?>">
                                              <?php echo get_phrase('manage_section');?>
                                          </a>
                                      </li>

                                      <li>
                                          <a href="<?php echo site_url('admin/admincourses/lessons/'.$course['id']); ?>">
                                      ...
                                      <li>
                                          <a href="<?php echo site_url('admin/admincourses/course_form/course_edit/'.$course['id']) ?>">
                                      ...
                                      <li class="divider"></li>
                                      <li>
                                          <a href="#" onclick="confirm_modal('<?php echo site_url('admin/admincourses/course_actions/delete/'.$course['id']); ?>');">
...
<script type="text/javascript">
    function ajax_get_sub_category(category_id) {
        $.ajax({
            url: '<?php echo site_url('admin/admincategories/ajax_get_sub_category/');?>' + category_id ,
