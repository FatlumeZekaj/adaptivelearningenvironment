...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('admin/admincategories/categories'); ?>"><?php echo get_phrase('categories'); ?></a> </li>
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                <div class="row">
                    <form class="" action="<?php echo site_url('admin/admincategories/sub_categories_by_category_id'); ?>" method="post">
                        ...
                        <div class="col-md-3">
                            <a href = "<?php echo site_url('admin/admincategories/sub_category_form/add_sub_category'); ?>" class="btn btn-lg btn-info" type="button" style="float: right; font-size: 13px;"><i class="fa fa-plus"></i> <?php echo get_phrase('add_sub_category'); ?></a>
                        </div>
                    </form>
                </div>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default" role="menu">
                                            <li>
                                                <a href="<?php echo site_url('admin/admincategories/sub_category_form/edit_sub_category/'.$sub_category['id']); ?>">
                                                    <?php echo get_phrase('edit');?>
                                                </a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#" onclick="confirm_modal('<?php echo site_url('admin/admincategories/sub_categories/'.$selected_category_id.'/delete/'.$sub_category['id']); ?>');">
