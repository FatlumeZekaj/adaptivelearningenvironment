...
function deleteQuizQuestionAndReloadModal(quizID, questionID) {
    var deletionURL = '<?php echo site_url(); ?>'+'admin/admincourses/quiz_questions/'+quizID+'/delete/'+questionID;
...
function sort() {
    ...
    $.ajax({
        url: '<?php echo site_url('admin/admincourses/ajax_sort_question/');?>',
        type : 'POST',
