    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-xl-12">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/admin/frontend_settings/banner_image_update'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-xl-12">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/admin/frontend_settings/light_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/admin/frontend_settings/dark_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/admin/frontend_settings/small_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/admin/frontend_settings/favicon'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
