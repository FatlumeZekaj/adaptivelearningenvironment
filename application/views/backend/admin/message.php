        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                ...
                <div class="mail-sidebar-row visible-xs">
                    <a href="<?php echo site_url('admin/admin/message/message_new');?>" class="btn btn-success btn-block">
                ...
                <ul class="navbar-nav">
                    ...
                    foreach($message_threads as $row):
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="text-left mb-1 btn btn-light d-block <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])echo 'active';?>" href="<?php echo site_url('admin/admin/message/message_read/' . $row['message_thread_code']);?>">
