							...
							<table class="table table-bordered table-centered mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('admin/admin/manage_language/edit_phrase/'.$language);?>"
												class="btn btn-info">
												<?php echo get_phrase('edit_phrase');?>
											</a>
											<a href="<?php echo site_url('index.php?admin/admin/manage_language/delete_language/'.$language);?>"
					...
					<div class="tab-pane" id="add" style="padding: 30px">
						<div class="row">
							<div class="col-xl-6">
								<div class="card">
									<div class="card-body">
										<form class="" action="<?php echo site_url('admin/admin/manage_language/add_phrase') ?>" method="post">
					...
					<div class="tab-pane" id="add_lang" style="padding: 30px">
						<div class="row">
							<div class="col-xl-6">
								<div class="card">
									<div class="card-body">
										<form class="" action="<?php echo site_url('admin/admin/manage_language/add_language'); ?>" method="post">
											<div class="form-group mb-3">
...
function updatePhrase(key) {
	...
	$.ajax({
		type : "POST",
		url  : "<?php echo site_url('admin/admin/update_phrase_with_ajax'); ?>",
