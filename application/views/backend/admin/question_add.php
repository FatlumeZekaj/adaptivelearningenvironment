<form action="<?php echo site_url('admin/admincourses/quiz_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('admin/admincourses/quiz_questions/'.$param2.'/add'); ?>',
        type: 'post',
