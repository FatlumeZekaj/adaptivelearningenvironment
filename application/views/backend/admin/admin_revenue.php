        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-xl-6">
                        <form class="form-inline" action="<?php echo site_url('admin/admin/admin_revenue/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                    ...
                    <table class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php foreach ($payment_history as $payment):
                                ...
                                <tr class="gradeU">
                                    <td><strong><a href="<?php echo site_url('admin/admincourses/course_form/course_edit/'.$course_data['id']); ?>" target="_blank"><?php echo ellipsis($course_data['title']); ?></a></strong></td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-danger btn-icon btn-rounded btn-sm" onclick="confirm_modal('<?php echo site_url('admin/admin/payment_history_delete/'.$payment['id'].'/admin_revenue'); ?>');"> <i class="dripicons-trash"></i> </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
