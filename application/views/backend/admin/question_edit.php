...
?>
<form action="<?php echo site_url('admin/admincourses/quiz_questions/'.$param3.'/edit/'.$param2); ?>" method="post" id = 'mcq_form'>
...
function showOptions(number_of_options){
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('admin/admincourses/manage_multiple_choices_options'); ?>",
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('admin/admincourses/quiz_questions/'.$param3.'/edit/'.$param2); ?>',
        type: 'post',
