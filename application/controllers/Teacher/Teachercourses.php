...
class Teachercourses extends CI_Controller {
    ...
    public function sections($param1 = "", $param2 = "", $param3 = "") {
        ...
        redirect(site_url('teacher/teachercourses/course_form/course_edit/'.$param1));
    }
    ...
    public function lessons($course_id = "", $param1 = "", $param2 = "") {
        ...
        if ($param1 == 'add') {
            ...
            redirect('teacher/teachercourses/course_form/course_edit/'.$course_id);
        }
        elseif ($param1 == 'edit') {
        ...
        elseif ($param1 == 'filter') {
            redirect('teacher/teachercourses/lessons/'.$this->input->post('course_id'));
        }
    ...
    public function quizes($course_id = "", $action = "", $quiz_id = "") {
        ...
        redirect(site_url('teacher/teachercourses/course_form/course_edit/'.$course_id));
    }
    ...
    public function quiz_questions($quiz_id = "", $action = "", $question_id = "") {
        ...
        elseif ($action == 'delete') {
            ...
            redirect(site_url('teacher/teachercourses/course_form/course_edit/'.$quiz_details['course_id']));
        }
    }
