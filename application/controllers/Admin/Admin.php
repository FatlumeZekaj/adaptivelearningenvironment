...
????????*/
  ...
  public function payment_history_delete($param1 = "", $redirect_to = "") {
    ...
    redirect(site_url('admin/admin/'.$redirect_to), 'refresh');
  }
  ...
  public function enrol_history_delete($param1 = "") {
    ...
    $this->session->set_flashdata('flash_message', get_phrase('data_deleted_successfully'));
    redirect(site_url('admin/admin/enrol_history'), 'refresh');
  }
  ...
  public function system_settings($param1 = "") {
    ...
    if ($param1 == 'system_update') {
      ...
      redirect(site_url('admin/admin/system_settings'), 'refresh');
    }
  ...
  public function frontend_settings($param1 = "") {
    ...
    if ($param1 == 'frontend_update') {
      ...
      redirect(site_url('admin/admin/frontend_settings'), 'refresh');
    }
  ...
  public function payment_settings($param1 = "") {
    ...
    if ($param1 == 'system_currency') {
      ...
      redirect(site_url('admin/admin/payment_settings'), 'refresh');
    }
  ...
  public function smtp_settings($param1 = "") {
    ...
    if ($param1 == 'update') {
      ...
      redirect(site_url('admin/admin/smtp_settings'), 'refresh');
    }
...
*/
  ...
  public function manage_language($param1 = '', $param2 = '', $param3 = ''){
    if ($param1 == 'add_language') {
      ...
      redirect(site_url('admin/admin/manage_language'), 'refresh');
    }
  ...
  function message($param1 = 'message_home', $param2 = '', $param3 = '')
  {
    ...
    if ($param1 == 'send_new') {
      ...
      redirect(site_url('admin/admin/message/message_read/' . $message_thread_code), 'refresh');
    }

    if ($param1 == 'send_reply') {
      $this->crud_model->send_reply_message($param2); //$param2 = message_thread_code
      $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
      redirect(site_url('admin/admin/message/message_read/' . $param2), 'refresh');
    }
  ...
  function manage_profile($param1 = '', $param2 = '', $param3 = '')
  {
    ...
    if ($param1 == 'update_profile_info') {
      $this->user_model->edit_user($param2);
      redirect(site_url('admin/admin/manage_profile'), 'refresh');
    }
...
*/
  public function payment_success($payment_type = "", $payment_id = "") {
    ...
    redirect(site_url('admin/adminusers/instructor_revenue'), 'refresh');
  }
